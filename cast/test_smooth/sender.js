...
var mediaURLs = [
    ...
    'http://homessvod-s.akamaihd.net/ondemand/1726669_Afre_Snon.ism/Manifest?hdnts=st=1410954572~exp=1411009572~acl=%2Fondemand%2F%2a~hmac=9eeae8fad77b89d4da37173b9f845aa880d6709717657c54f8c1e1138fb7b071',
    'http://homessvod-s.akamaihd.net/ondemand/0_Afre_Snon.ism/Manifest?hdnts=st=1410954572~exp=1411009572~acl=%2Fondemand%2F%2a~hmac=9eeae8fad77b89d4da37173b9f845aa880d6709717657c54f8c1e1138fb7b071',
    'http://akamai.dvdpost.be/53a837851fb4d1.09073194_fre_non.m3u8',
...
function loadMedia(mediaURL) {
  ...
  console.log(mediaInfo.contentType)
  var request = new chrome.cast.media.LoadRequest(mediaInfo);
  request.currentTime = initialTimeIndexSeconds;
  request.autoplay = true;
  console.log(currentMediaURL.lastIndexOf('ism/'))
  var payload = {
