<?php 
//BEN001 $sql = "SELECT products_image_big FROM products_description_adult WHERE products_id='".$HTTP_GET_VARS['products_id']."'";
$sql = "SELECT products_image_big FROM products_description WHERE products_id='".$HTTP_GET_VARS['products_id']."'"; //BEN001
$query_search_products = tep_db_query($sql);
$query_search_products_values = tep_db_fetch_array($query_search_products)
?>
<form name="product_reviews_write" method="post" action="<?php  echo tep_href_link(FILENAME_PRODUCT_REVIEWS_WRITE_ADULT, 'action=process&products_id=' . $HTTP_GET_VARS['products_id'], 'NONSSL'); ?>" onSubmit="return reviewcheckForm();">
  ...
  <tr>
	...
	<td width="762" class="SLOGAN_DETAIL">
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td width="12%" height="130" rowspan="2" align="center" valign="middle" bgcolor="#F7EAF4" class="SLOGAN_DETAIL"><b><img src="<?php  echo DIR_WS_IMAGESX . $query_search_products_values['products_image_big'];?>" width="70" height="105"><br>
                </b></td>
                <td width="88%" height="33" bgcolor="#F7EAF4" class="SLOGAN_DETAIL"><b><?php  echo SUB_TITLE_PRODUCT; ?></b> <?php  echo $product_info_values['products_name']; ?></td>
                <td width="0%" rowspan="5" align="right" valign="top"><br>
                </td>
              </tr>
              <tr>
                <td height="32" bgcolor="#F7EAF4" class="SLOGAN_DETAIL"><b><?php  echo SUB_TITLE_FROM; ?></b> <?php  echo $customer_values['customers_firstname'] . ' ' . $customer_values['customers_lastname']; ?></td>
              </tr>
              <tr>
