...
<?php 
  //BEN001 $countsc_query = tep_db_query("select count(*) as cc from shopping_cart_adult where customers_id = '" . $customer_id . "' ");
  $countsc_query = tep_db_query("select count(*) as cc from shopping_cart sc left join products p on (sc.products_id= p.products_id) where products_type = 'DVD_ADULT' and  customers_id = '" . $customer_id . "' "); //BEN001
...
if ($countsc['cc']>0) {
?>
  <form name="form1" action="shoppingcartupdate_adult.php" method="post">
  		<table width="764" border="0" align="center" cellpadding="0" cellspacing="0">
    	  <tr align="center">
...
//BEN001      			$sc_query = tep_db_query("select * from shopping_cart_adult sc left join products_adult p on sc.products_id = p.products_id left join products_description_adult pd on pd.products_id = sc.products_id and pd.language_id='" . $languages_id . "' where sc.customers_id = '" . $customer_id . "' ");
      			$sc_query = tep_db_query("select * from shopping_cart sc left join products p on sc.products_id = p.products_id left join products_description pd on pd.products_id = sc.products_id and pd.language_id='" . $languages_id . "' where productd_type = 'DVD_ADULT' and sc.customers_id = '" . $customer_id . "' "); //BEN001
  ...
  <tr>
    <td  valign="middle" height="40">
	  <div align="right">
	    <a href='dvdforsale_listing_adult.php'><img src="<?php  echo DIR_WS_IMAGES_LANGUAGES.$language;?>/images/buttons/button_show_shopping_list.gif" border="0" align="absbottom"></a>
	  	<img src="<?php  echo DIR_WS_IMAGES;?>blank.gif" width="220" height="14">
	    <input name="submit" type="image" src="<?php echo DIR_WS_IMAGES_LANGUAGES . $language;?>/images/buttons/button_update_shopping_cart.gif" align="absbottom"  border="0">
	  	...
	  	<a href='shopping_cart_checkout_adult.php'><img src="<?php  echo DIR_WS_IMAGES_LANGUAGES.$language;?>/images/buttons/button_confirm_buy.gif" border="0" align="absbottom"></a>
	  </div>
	</td>
  </tr>
  </table>
	...
	<table width="764" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr >
			<td align="center" width="14">
				<br>
					<div align="center">
					    <a href='dvdforsale_listing_adult.php'><img src="<?php  echo DIR_WS_IMAGES_LANGUAGES.$language;?>/images/buttons/button_show_shopping_listx.gif" border="0" align="absbottom"></a>				  	
					</div>
				<br>
			</td>
		</tr>
