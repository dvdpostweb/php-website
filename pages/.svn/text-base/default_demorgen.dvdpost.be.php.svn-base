...
<div class="main-holder">
	<form name="form1" method="post" action="activation_code_confirm.php">
	  <div id="cinenews_dvd"><img src="<?php echo DIR_WS_IMAGES_LANGUAGES.$language ;?>/images/header_demorgen.jpg"></div>
	  <div id="promo">
	    <div id="promo_area">
	      <p class="text_promo" ><?php echo TEXT_GFC_TITLE ;?></p>
				<p style="margin:0">
	      	<input name="code" id="code" class="inputs_codes_demorgen" value="" size="20" type="text">
	      	<input class="no_border_button" name="imageField" src="images/button_go.gif" type="image" align="absmiddle" border="0" >
				</p>
	    </div>
	    <div id="help_area" align="center"><img src="<?= DIR_WS_IMAGES_LANGUAGES.$language  ?>/images/help_grey.gif" width="347" height="72" /></div>
	    <div class="clear"></div>
	    <p class="footer_actu"><?= TEXT_DEMORGEN ?> | <a href="/conditions.php"><strong><?= TEXT_CONDITION_SUMMER ?></strong></a></p>
