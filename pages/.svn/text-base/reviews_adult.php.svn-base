<table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	<td height="6" colspan="4" valign="top"><div align="center"><img src="<?php  echo DIR_WS_IMAGES;?>line-it.jpg" width="760" height="6"></div></td>
  </tr>
  <tr>
    <td colspan="4" class="slogan_orange">
		<?php 
//BEN001		  $reviews_query_raw = "select r.reviews_id, rd.reviews_text, r.reviews_rating, r.date_added, p.products_id, pd.products_name, p.products_image, r.customers_name from " . TABLE_REVIEWS . " r, " . TABLE_REVIEWS_DESCRIPTION . " rd, products_adult p, products_description_adult  pd where p.products_status = '1' and p.products_id = r.products_id and r.reviews_id = rd.reviews_id and r.reviews_check = '1' and p.products_id = pd.products_id and pd.language_id = '" . $languages_id . "' and rd.languages_id = '" . $languages_id . "' order by r.reviews_id DESC";
		  $reviews_query_raw = "select r.reviews_id, r.reviews_text, r.reviews_rating, r.date_added, p.products_id, pd.products_name, pd.products_image_big, r.customers_name from " . TABLE_REVIEWS . " r,  products p, products_description  pd where p.products_status = '1' and p.products_id = r.products_id and r.reviews_check = '1' and p.products_id = pd.products_id and pd.language_id = '" . $languages_id . "' and r.languages_id = '" . $languages_id . "' and products_type = 'DVD_ADULT' order by r.reviews_id DESC"; //BEN001
		...
		?>
		      <tr>
		        <td>
					<?php 
		              include(getBestMatchToInclude(DIR_WS_COMMON . 'pages/parts/reviews/reviews_adult.php'));
					?>
		        </td>
		      </tr>
		<?php 
