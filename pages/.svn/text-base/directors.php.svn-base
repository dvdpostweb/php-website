...
<?php 
$director_info = tep_db_query("select Directors_Name, Directors_image , Directors_dateofbirth , Directors_awards, Directors_description from " . TABLE_DIRECTORS . " where Directors_id = '" . $HTTP_GET_VARS['directors_id'] . "' ");
...
<table border="0" align="center" cellpadding="0" cellspacing="0">
 <tr>
	...
	<?php  echo TEXT_DIRECTOR_NAME. ' : ' .$director_info_values['Directors_Name']; ?>
	</td>
  </tr>
  <tr>
              ...
              <td width="100" height="150" rowspan="5">
	                <?php 
	              	switch ($product_info_values['products_media']){
						...
						default :
							echo '<a href="product_info.php?products_id='.$product_info_values['products_id'].'">';
							echo '<img src="'.DIR_DVD_WS_IMAGES.$product_info_values['products_image_big'].'" border="0" width="108" height="162" alt="'.$tag_dvd.'">';
							echo '</a></td>';
            ...
            <tr> 
              <td height="30" bordercolor="#FFFFFF" bgcolor="#EAEAEA"> <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr > 
                    ...
                    <td bordercolor="#FFFFFF" bgcolor="#EAEAEA" class="SLOGAN_DETAIL"><span class="TYPO_STD_BLACK_bold"><a href="directors.php?directors_id=<?php  echo $_GET['directors_id'];?>" class="basiclink"><u><?php  echo $director_info_values['Directors_Name'];?></u></a></span></td>
                  </tr>
                </table></td>
            </tr>
            <tr> 
