...
//BEN001 Comment    $undertitles_query = tep_db_query("select ut.products_undertitles_id from products_to_undertitles_adult ut where ut.products_id = '" . $product_info_values['products_id'] . "'");
    $undertitles_query = tep_db_query("select ut.products_undertitles_id from products_to_undertitles ut where ut.products_id = '" . $product_info_values['products_id'] . "'");
    ?>
<table width="764"  align="center" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td rowspan="3" width="2" background="<?php  echo DIR_WS_IMAGES;?>separator_two.jpg"><img src="<?php  echo DIR_WS_IMAGES;?>blank.gif" width="2" height="1"></td>
    ...
    <td>
      ...
      <tr>
		...
		case 'BlueRay' :
			...
			echo '<td><img class="bluborder" src="'.DIR_WS_IMAGESX.$product_info_values['products_image_big'].'" border="0" width="160" alt="'.$tag_dvd.'"></td>';
			echo '</tr></table></td>';								
			break;
		
		default :
			echo '<td height="240" colspan="2" align="center" valign="top"><img src="'.DIR_WS_IMAGESX.$product_info_values['products_image_big'].'" width="160" height="240" alt="'.$tag_dvd.'"></td>';
			break;
		}
		?>
		</tr>
              <td width="200" align="center" valign="top" nowrap>
			   ...
			   ?>
			   <?php  include(getBestMatchToInclude(DIR_WS_COMMON . 'pages/parts/product_info_adult/button_addtowishlist.php'));?><br>
			   <br>
			   <?php  include(getBestMatchToInclude(DIR_WS_COMMON . 'pages/parts/product_info_adult/button_buy.php'));?>
			   <br>
			   <?php  include(getBestMatchToInclude(DIR_WS_COMMON . 'pages/parts/product_info_adult/button_buy_new.php')); ?>
			  </td>
            </tr>
        </table></td>
        <td colspan="2" align="center" valign="top" bgcolor="#FFFFFF" class="TYPO_STD_BLACK_bold"><?php  include(getBestMatchToInclude(DIR_WS_COMMON . 'pages/parts/product_info_adult/table_title_description.php'));?>
        </td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td>
        ...
        <td><br>
				<?php  
					include(getBestMatchToInclude(DIR_WS_COMMON . 'pages/parts/product_info_adult/table_reviews.php'));
