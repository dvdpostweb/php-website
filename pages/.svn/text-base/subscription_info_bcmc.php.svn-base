			...
			if ($customers['domiciliation'] > 0){
				...
				if ($customers[domiciliation_status]>0){
					...
					if ($product_info_values = tep_db_fetch_array($product_info)){					  		
				  	?>
			            <form name="subcc" action="subscription_confirm_bcmc.php" method="post">
			              <p>
			                      ...
			                      <tr valign="middle">
			                        ...
			                        <td class="SLOGAN_DETAIL" valign="middle"><?php  echo  TEXT_SUBSCRIPTION; ?>: <b><?php  echo $product_info_values['products_name'];?></b> <br>
			                            ...
			                            if($HTTP_GET_VARS['discount_code_id']>0){
				                            ...
				                            echo TEXT_FIRST_PAYMENT .'<b>'. $final_price .' &euro;</b><br><br>';
			                      ...
			                      <tr >
			                        <td class="SLOGAN_DETAIL"><table  width=100%>
			                            <?php 
								        	...
								        	?>
			                            <tr>
			                              <td class="SLOGAN_DETAIL"><?php  echo TEXT_BCMC; ?></td>
			                              <td class="SLOGAN_DETAIL"><input type="radio" name="payment" value="bcmc"></td>
			                            </tr>
			                            <tr>
			                              <td class="SLOGAN_DETAIL"><?php  echo TEXT_INGHOMEPAY; ?></td>
			                              <td class="SLOGAN_DETAIL"><input type="radio" name="payment" value="inghomepay"></td>
			                            </tr>
			                            <tr>
			                              <td class="SLOGAN_DETAIL"><?php  echo TEXT_CBCONLINE; ?></td>
			                              <td class="SLOGAN_DETAIL"><input type="radio" name="payment" value="cbconline"></td>
			                            </tr>
			                            <tr>
			                              <td class="SLOGAN_DETAIL"><?php  echo TEXT_DEXIANETBANKING; ?></td>
			                              <td class="SLOGAN_DETAIL"><input type="radio" name="payment" value="dexianetbanking"></td>
			                            </tr>
			                            <tr>
			                              <td class="SLOGAN_DETAIL"><?php  echo TEXT_KBCONLINE; ?></td>
			                              <td class="SLOGAN_DETAIL"><input type="radio" name="payment" value="kbconline"></td>
			                            </tr>
			                            <tr>
			                              <td class="SLOGAN_DETAIL" colspan=2>
			                              <a class="red_basiclink" href="subscription_info_dom.php?products_id=<?php  echo $HTTP_GET_VARS['products_id'];?>&discount_code_id=<?php  echo $HTTP_GET_VARS['discount_code_id'];?>"><?php  echo TEXT_LINK_DOM; ?></a>
			                              <br>
			                              <a class="red_basiclink" href="subscription_info.php?products_id=<?php  echo $HTTP_GET_VARS['products_id'];?>&discount_code_id=<?php  echo $HTTP_GET_VARS['discount_code_id'];?>"><?php  echo TEXT_LINK_CC; ?></a>
			                              </td>
			                            </tr>
			                        </table></td>
			                      </tr>
