...
<form name="form1" method="post" action="activation_code_confirm.php">
                ...
                <p><?php echo TEXT_STUDENT_EXPLAIN ;?></p>
                 ...
                 <input name="activation_code" id="code" type="text" class="inputs_codes" size="20" value="" size="18" onclick="form1.code.value='';">&nbsp;<input class="no_border_button" name="imageField" type="image" src="http://www.dvdpost.be/images/www3/languages/french/images/ptg/go.gif" width="69" height="21" align="absmiddle" border="0"><br /><br />
