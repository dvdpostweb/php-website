...
.student {
background:url(<?php echo DIR_WS_IMAGES_LANGUAGES.$language.'/images/student/home.jpg' ;?>);
	...
	<tr class="student">
		<td width="773" height="500" valign="top"  >
				<p class="student_title"><?php echo TEXT_STUDENT_TOP ;?></p>
			  	<div id="promo_code">
	                <p class="logo_student"><img src="<?php echo DIR_WS_IMAGES_LANGUAGES.$language.'/images/student/student.gif' ;?>" /></p>
				  ...
				  <img src="<?php echo DIR_WS_IMAGES_LANGUAGES.$language.'/images/student/phone.gif' ;?>" />
                </div>
		</td>
	</tr>
