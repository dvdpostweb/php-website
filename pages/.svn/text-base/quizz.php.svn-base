...
foreach($quizz_values_tab as $quizz_values){
	...
	echo '</tr>';
	echo '<tr>
	     <td width="134" height="114" align="left" valign="middle" ><a href="quizz2.php?quizzid='.$quizzid.'"><img src="/images/www3/quizz/q'.$quizzid.'.jpg" width="114" height="94" border="0"></a></td>
	     <td width="466" align="left" valign="middle" class="SLOGAN_DETAIL"><a href="quizz2.php?quizzid='.$quizzid.'" class="basiclink"><b>'.$title.'</b></a></td>';
	  echo '</tr></table></td>';
