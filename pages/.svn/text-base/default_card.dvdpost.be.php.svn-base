...
.cinenews {
background:url(<?php echo DIR_WS_IMAGES_LANGUAGES.$language.'/images/cardeck/home.jpg' ;?>);
...
<form name="form1" method="post" action="activation_code_confirm.php">
				...
				<div id="cinenews_dvd"><img src="<?php echo DIR_WS_IMAGES_LANGUAGES.$language ;?>/images/cardeck/home.jpg"></div>
			  	<div id="promocode">
                <p>Activeer hieronder uw GRATIS abonnement <br />met behulp van uw promotiecode <font color="#CC0000"><strong>CARD6DVD</strong></font> of <font color="#CC0000"><strong>DECK6DVD</strong></font></p>
