<table width="731" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr> 
    <td width="244" rowspan="4" align="center" valign="top" class="limitedtitle"> 
      	<table cellpadding="0" cellspacing="0" border="0" align="center" width="220">
			...
			<tr>
				<td width="20" valign="top">*</td>
				<td width="200" valign="top" class="TYPO_STD_BLACK"><?php  echo TEXT_DOM_AFTER_BCMC ;?></td>
			</tr>
			<tr>
				<td height="170" colspan="2" valign="top">&nbsp;</td>		
			</tr>
			<tr>
				<td colspan="2">
  ...
  <?php  
  include(getBestMatchToInclude(DIR_WS_COMMON . 'includes/step/step_subscription_info_bcmc_form.php'));  
  ?>
  <tr> 
