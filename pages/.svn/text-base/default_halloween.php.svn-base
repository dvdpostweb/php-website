...
<table width="773" height="473" border="0" cellpadding="0" cellspacing="0" bgcolor="000000" >
	...
	<tr>
		<td width="773" height="473" valign="top" background="<?php echo DIR_WS_IMAGES.'halloween/home_halloween.jpg';?>">
			<div id="right_halloween">
				<b><?php echo TEXT_BEST_WAY ;?></b>
				<?php if (ENTITY_ID < 38){
					?>
						<div id="pastille_halloween"><a href="<?php echo $link_freetrial ;?>"><img src="<?php echo DIR_WS_IMAGES.'languages/'.$language.'/images/halloween/pastille_halloween.png' ;?>" border="0" /></a></div>
					<?php }else{
					?>	
						<div id="pastille_halloween"><a href="<?php echo $link_freetrial ;?>"><img src="<?php echo DIR_WS_IMAGES.'languages/'.$language.'/images/halloween/pastille_halloween_nl.png' ;?>" border="0" /></a></div>
					<?php
					}
					?>
