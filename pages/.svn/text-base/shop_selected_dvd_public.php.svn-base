...
//echo $listing_sql;
  //if ($listing_numrows = 0) {  
	...
	$split=$cPath;
	$search_title= TEXT_DVDPOST_SELECT;
					...
					while ($product_info_values = tep_db_fetch_array($listing)) {
						...
						<form name="form1" method="post" action="addtoshoppingcart_public.php">							
							<table width="213" border="0" align="center" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td>
										<TABLE width="102" border="0" cellpadding="0" cellspacing="0"  align="center">										
										    ...
										    <TR>
												<TD WIDTH="87" HEIGHT="130" valign="top"><a href="product_info_shop_public.php?products_id=<?php  echo $product_info_values['products_id'].'"><img src="'.DIR_DVD_WS_IMAGES.$product_info_values['products_image_big'] ;?>" border="0" WIDTH="87" HEIGHT="130" ALT="<?php  echo $product_info_values['products_name'] ;?>"></a></TD>
											</TR>
											<TR>
								...
								<tr>
									<td align="center">
									  <a href="product_info_shop_public.php?products_id=<?php  echo $product_info_values['products_id'] ;?>"><img src="<?php  echo DIR_WS_IMAGES_LANGUAGES.$language;?>/images/buttons/button_buy.gif" border="0"></a>
									</td>
								</tr>
							</table>
						</form><br>
