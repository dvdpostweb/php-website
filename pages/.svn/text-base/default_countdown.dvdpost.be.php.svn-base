...
<div class="main-holder">
	<form name="form1" method="post" action="activation_code_confirm.php">
	  <div id="cinenews_dvd"><img src="<?php echo DIR_WS_IMAGES_LANGUAGES.$language ;?>/images/header_countdown.jpg"></div>
	  <div id="promo">
	    <div id="promo_area">
	      <p class="text_promo" ><?php echo TEXT_GFC_TITLE ;?></p>
				<p style="margin:0">
	      	<input name="code" id="code" class="inputs_codes_groupon" value="countdown" size="20" type="text">
	    ...
	    <div class="clear"></div>
	    <p class="footer_actu"> <a href="/conditions.php"><strong><?= TEXT_CONDITION_SUMMER ?></strong></a></p>
