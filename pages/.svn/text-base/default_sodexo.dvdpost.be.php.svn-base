...
.cinenews {
background:url(<?php echo DIR_WS_IMAGES_LANGUAGES.$language.'/images/sodexo/home.jpg' ;?>);
...
<form name="form1" method="post" action="activation_code_confirm.php">
				...
				<div id="cinenews_dvd"><img src="<?php echo DIR_WS_IMAGES_LANGUAGES.$language ;?>/images/sodexo/home.jpg"></div>
			  	<div id="promocode">
