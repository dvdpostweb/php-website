...
<div class="main-holder">
	<form name="form1" method="post" action="activation_code_confirm.php">
	  <div id="cinenews_dvd"><img src="<?php echo DIR_WS_IMAGES_LANGUAGES.$language ;?>/images/header_gfc.jpg"></div>
	  <div id="promo">
	    <div id="promo_area">
	    ...
	    <div class="clear"></div>
	    <p class="footer_actu"><?= TEXT_GFC ?> | <a href="/conditions.php"><strong><?= TEXT_CONDITION_SUMMER ?></strong></a></p>
