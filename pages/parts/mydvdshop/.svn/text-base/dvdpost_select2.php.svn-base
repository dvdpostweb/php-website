<table width="280" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    ...
    <td width="267" align="left" background="<?php  echo DIR_WS_IMAGES;?>shop/titlebar/box/title_mid.gif" class="dvdpost_left_menu_title_shop"><b><?php  echo TEXT_DVD_FOR ;?> 3.95€ </b></td>
    ...
    <td colspan="2" valign="top">
    	<table width="100%">
    		<tr> 			
				...
				$listing_sql.=' ORDER BY RAND() LIMIT 4 ';
