<table width="267" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	$shopping_sql.='WHERE customers_id = '. $customer_id .' and products_type NOT like "VOD" group by customers_id';
    ...
    <td height="25" align="left" valign="middle" background="<?php  echo DIR_WS_IMAGES;?>shop/titlebar/welcome/w_white_bckg.gif" class="SLOGAN_DETAIL" style="padding-left:15px;">
		<img src="<?php  echo DIR_WS_IMAGES;?>shop/titlebar/welcome/caddie.gif" width="25" height="25" align="absmiddle">
		<img src="<?php  echo DIR_WS_IMAGES;?>blank.gif" width="10" height="8" align="baseline">
		<?php  echo $inthebag ;?> (<a class="red_slogan" href="shopping_cart.php"><?php  echo TEXT_SEE ;?></a>) 
	</td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="30" background="<?php  echo DIR_WS_IMAGES;?>shop/titlebar/welcome/w_white_bckg.gif"  style="padding-left:43px;">
		<a href="shopping_cart.php" class="red_slogan"><?php  echo TEXT_CONFIRM_ORDER ;?></a>
	</td>
  </tr>
  <tr>
    <td background="<?php  echo DIR_WS_IMAGES;?>shop/titlebar/welcome/w_white_bckg.gif">&nbsp;</td>
  ...
  <tr>
	<?php  
	$status1_sql="SELECT sum( quantity )as QUANTITY FROM  `shopping_orders` WHERE  `customers_id`  = ". $customer_id ." AND  `status`  = 1 AND products_type='DVD_NORM' ";
    ...
    <td height="30" align="left" valign="middle" background="<?php  echo DIR_WS_IMAGES;?>shop/titlebar/welcome/w_light_grey_bckg.gif" class="SLOGAN_DETAIL" style="padding-left:15px;">
		...
		(<a class="red_slogan" href="mydvdbought.php"><?php  echo TEXT_SEE;?></a>)
	</td>
  </tr>
  <tr>
	<?php  
	$status2_sql="SELECT sum( quantity )as QUANTITY FROM  `shopping_orders` WHERE  `customers_id`  = ". $customer_id ." AND  `status`  = 2 AND products_type='DVD_NORM' ";
