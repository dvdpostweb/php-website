<table width="758" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="149" background="<?php  echo DIR_WS_IMAGES;?>shop/titlebar/box/title_mid.gif" class="dvdpost_left_menu_title" align="left"><b><?php  echo TEXT_DVD_LIMITED;?></b></td>
    ...
    <td colspan="3">
    	<table width="100%">
    		<tr>    			
				...
				$listing_sql.='WHERE `quantity_to_sale`  > 0 and p.products_id=pd.products_id and quantity_to_sale<10  and pd.language_id=' . $languages_id ;
				switch ($languages_id){
					case 1:
				...
				$listing_sql.=' ORDER BY RAND() LIMIT 12 ';
				$listing = tep_db_query($listing_sql);
				$i=1;
				while ($product_info_values = tep_db_fetch_array($listing)) {
					echo '<td width="16%" align="center"><table><tr><form name="form1" method="post" action="addtoshoppingcart.php">';
					...
					if ($i==6){echo '</tr></table><table width="100%"><tr>';}
					$i++;	
				}				  
			    ?>
	    	</tr>
		...
		<br>
		<div align="right"><a href="shop_listing.php?lim=1" class="red_slogan"><?php  echo TEXT_SEE_ALL ;?></a></div>
    </td>
