<table width="395" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="149" background="<?php  echo DIR_WS_IMAGES;?>shop/titlebar/box/title_mid.gif" class="dvdpost_left_menu_title" align="left"><b><?php  echo TEXT_LAST_DVD_ADDED;?></b></td>
  ...
  <tr>
    ...
    <td colspan="3">
		...
		<br>
		<div align="right"><a href="shop_last_added.php" class="red_slogan"><?php  echo TEXT_SEE_ALL ;?></a></div>    
    </td>
