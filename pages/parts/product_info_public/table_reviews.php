  ...
  <tr>
    <td colspan="3" class="TYPO_STD_BLACK">
                    ...
                    if (tep_db_num_rows($reviews)) {
                        ...
                        echo '<br>';
                        $reviews_desc = tep_db_query("select rd.reviews_text, r.reviews_rating, r.reviews_id, r.products_id, r.customers_name, r.date_added, r.last_modified, r.reviews_read from " . TABLE_REVIEWS . " r, " . TABLE_REVIEWS_DESCRIPTION . " rd where r.reviews_id = '" . $reviews_values['reviews_id'] . "' and r.reviews_id = rd.reviews_id");
