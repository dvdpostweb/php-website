	<table border="0" align="center" cellpadding="0" cellspacing="0" width="560">
  		...
  		<tr>  			
			...
			$listing_sql.= ' and p.products_type = "DVD_ADULT" and p.products_product_type= "Movie" and p.products_status>-1 '; //BEN001
			switch ($languages_id){					
					case 1:
			...
			$listing_sql.=' and p.products_availability>0 and p.products_rating>3 and p.products_id not in ('.$restrict.') group by pd.products_image_big  order by products_date_available  desc LIMIT 200 ';
			...
			foreach($listing as $listing_query_values){	
					...
					case 'BlueRay' :
						...
						echo '<img class="bluborder" src="'.$constants['DIR_WS_IMAGESX'].'/'.$listing_query_values['products_image_big'].'" border="0" width="88" height="118" alt="'.$tag_dvd.'" valign="top"></a></td></tr></table>';
						echo '</td></tr>';
						break;
					
					default :
						echo '<tr><td><br/><a href="'. products_link($lang_short,$listing_query_values['products_name'],$listing_query_values['products_id']).'"><img class="border_dvd" src="'.DIR_WS_IMAGESX.$listing_query_values['products_image_big'].'" border="0" width="90" height="135" alt="'.$listing_query_values['products_name'].'" title="'.$listing_query_values['products_name'].'"></a></td></tr>';
						break;
					}	
					echo '<tr>
