<table width="250" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="149" background="<?php  echo DIR_WS_IMAGES;?>shop/titlebar/box/title_mid.gif" class="dvdpost_left_menu_title_shop" align="left"><b><?php  echo TEXT_BEST_BUY;?></b></td>
  ...
  <tr>
    ...
    <table width="100%">
    		<tr>    			
				...
				$listing_sql.=' GROUP  BY so.products_id ORDER  BY  `sum( so.quantity )`  DESC LIMIT 4';
				...
				while ($product_info_values = tep_db_fetch_array($listing)) {
						...
						echo '<td align="right"><input name="imageField" type="image" src="'.DIR_WS_IMAGES.'shop/titlebar/box/add.gif" width="27" height="21" border="0"></td></form></tr></table></td>';
							if ($i==2){echo '</tr><tr><td colspan="2" height="20">&nbsp;</td><tr>';}
						$i++;
						}					
