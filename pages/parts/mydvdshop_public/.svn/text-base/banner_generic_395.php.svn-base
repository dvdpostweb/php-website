<div align="center">
 <?php  
    	...
    	echo '<a href="'.str_replace('.php','_public.php',$banner_values['banners_url']).'"><img src="'.DIR_WS_IMAGES.'languages/'.$language.'/images/shop/'.$banner_values['banners_image'].'" border="0"  alt="Shop DVDPost"></a>';
	?>
</div>