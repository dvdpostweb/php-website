<table width="194" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    ...
    <td width="173" align="left" background="<?php  echo DIR_WS_IMAGES;?>shop/titlebar/box/title_mid.gif" class="dvdpost_left_menu_title_shop"><b><?php  echo TEXT_DVDPOST_SELECT;?></b></td>
    ...
    <td colspan="2" valign="top">
    	<table width="174" border="0" cellspacing="0" cellpadding="0" align="center">
    		<tr> 
				...
				$listing_sql.=' ORDER BY RAND() LIMIT 3 ';
				...
				while ($product_info_values = tep_db_fetch_array($listing)) {					
					...
					if ($i<3){echo '<table><tr><td height="20">&nbsp;</td></tr></table>';}
				$i++;
				}				  
			    ?>
			    </td>
		...
		<br>
		<div align="right"><a href="shop_selected_dvd_public.php" class="red_slogan"><?php  echo TEXT_SEE_ALL ;?></a></div>  
    </td>
