...
<table width="374" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="350" background="<?php  echo DIR_WS_IMAGES;?>img_recom/top_line_recom2_x.gif" class="SLOGAN_GRIS_13px"><?php  echo TEXT_SHOPPING_ACTIVITY;?></td>
    ...
    <td><table border="0" align="left" cellpadding="0" cellspacing="0" >
			...
			<tr>
				<td colspan="3">
					<table width="100%">
					<?php  
		  			$sc_query = tep_db_query("select * from shopping_cart sc left join products p on sc.products_id = p.products_id left join products_description_adult pd on pd.products_id = sc.products_id and pd.language_id='" . $languages_id . "' where sc.customers_id = '" . $customer_id . "' ");
		   			while ($sc = tep_db_fetch_array($sc_query)) {		      		
		      			?>
							<tr>
		        				<td width="214" height="25"><img src="<?php  echo DIR_WS_IMAGES ;?>blank.gif" width="14" height="3">         					
		            				<a href="shopping_cart_adult.php" class="dvdpost_brown_underline"><?php  echo $sc['products_name'];?></a>
		          				</td>
								<td width="5">&nbsp;</td>
		...
		<tr><td><a href="shopping_cart_adult.php" class="dvdpost_brown_underline"><?php  echo TEXT_VIEW_SHOPPINGCART ;?></a> - <a href="shopping_cart_checkout_adult.php" class="dvdpost_brown_underline"><?php  echo TEXT_CONFIRM_ORDER;?></a> <br><br> <a href="mydvdbought_adult.php" class="dvdpost_brown_underline"><?php  echo TEXT_HISTORY_BOUGHT;?></a></td></tr>            
    </table>
	</td>
