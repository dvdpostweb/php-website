...
<table width="374" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="350" background="<?php  echo DIR_WS_IMAGES;?>img_recom/top_line_recom2_x.gif" class="SLOGAN_GRIS_13px"><?php  echo TEXT_RENTAL_ACTIVITY;?></td>
    <td width="10"><img src="<?php  echo DIR_WS_IMAGES;?>img_recom/top_right_recom2_x.gif" width="14" height="25"></td>
  </tr>
  <tr>
    ...
    <td><table border="0" align="left" cellpadding="0" cellspacing="0" >
		...
		while ($dvdathome_values = tep_db_fetch_array($dvdathome)) {
   			echo '<tr>';
   			echo '<td width="214" height="25"><img src="'.DIR_WS_IMAGES.'blank.gif" width="14" height="3"><a href="mywishlist_adult.php" class="dvdpost_brown_underline">';
		...
		<tr><td><a href="mywishlist_adult.php" class="dvdpost_brown_underline"><?php  echo TEXT_VIEW_ALL;?></a> - <a href="custserv_list.php" class="dvdpost_brown_underline"><?php  echo TEXT_REPORT_A_PROBLEM;?></a></td></tr>     
		...
		//$dvdathome = tep_db_query("select * from orders o left join orders_products op on o.orders_id =op.orders_id where o.customers_id= '".$customer_id."' and o.orders_status = 15 ");  
	/*	while ($dvdathome_values = tep_db_fetch_array($dvdathome)) {
   			echo '<tr>';
		...
		<?php  
		$dvdathome = tep_db_query("select * from orders o left join orders_products op on o.orders_id =op.orders_id where o.customers_id= '".$customer_id."' and o.orders_status = 3 order by o.orders_id desc limit 3");  
		$dvdathome_values = tep_db_fetch_array($dvdathome);
		while ($dvdathome_values = tep_db_fetch_array($dvdathome)) {
   			echo '<tr>';
   			echo '<td width="214" height="25"><img src="'.DIR_WS_IMAGES.'blank.gif" width="14" height="3"><a href="myrentals_adult.php" class="dvdpost_brown_underline">';
   			echo $dvdathome_values['products_name'];
   			echo '</a></td>';
   			echo '<td width="5">&nbsp;</td>';
   			echo '<td align="center" class="TYPO_STD_GREY">';
		...
		<tr><td><a href="myrentals_adult.php" class="dvdpost_brown_underline"><?php  echo TEXT_VIEW_ALL;?></a> - <a href="custserv_list.php" class="dvdpost_brown_underline"><?php  echo TEXT_REPORT_A_PROBLEM;?></a></td></tr>            
    </table>
	</td>
