 <?php   
    ...
    $actors = tep_db_query("select a.actors_id,a.Actors_Name from products_to_actors pa join actors a on pa.actors_id = a.actors_id and a.actors_type = 'DVD_ADULT' where pa.products_id = '" . $product_info_values['products_id'] . "'"); //RALPH-002
?>
  	...
  	<tr valign="top">
    	...
    	<td height="20" bgcolor="F7EAF4" class="TYPO_STD_BLACK">
      		<?php  
				...
				echo '<A class="basiclink" href="studio_adult.php?studio_id='. $product_info_values['products_studio'] .' "><u>' . $studio_values['studio_name'] . '</u></A> ';
       		?>
    	</td>
  	</tr>
	<tr valign="top">
    	...
    	<td height="20" bgcolor="F7EAF4" class="TYPO_STD_BLACK">
      		<?php  
				...
				$i=0;
      			...
      			echo '<A class="basiclink" href="actors_adult.php?actors_id='.$actors_values['actors_id'].'"><u>' . $actors_values['Actors_Name'] . '</u></A> ';
      			$i++;
				if($i!=$nb)
					echo ', &nbsp;';
      			}
...
<tr valign="middle" bgcolor="#F7EAF4">
	...
	<tr>
		<td colspan="2" align="center">
			<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="F7EAF4">
			  <tr>
    			<td bgcolor="#FFFFFF" align="center"><img src="<?php   echo DIR_WS_IMAGES;?>blank.gif" width="14" height="3"></td>
  			  </tr>
			  <tr>
                <td align="center" class="TYPO_STD_BLACK"><span id='rating_all'><?php   include(DIR_WS_COMMON . 'pages/parts/product_info_adult/table_average_ranking.php'); ?><span></td>
              </tr>
            </table>
      </td>
  	</tr>
