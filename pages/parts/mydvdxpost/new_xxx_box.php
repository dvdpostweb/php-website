<table width="269"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td rowspan="2" background="<?php   echo DIR_WS_IMAGES;?>img_recom/left_line_recom.gif"><img src="<?php   echo DIR_WS_IMAGES;?>blank.gif" width="14" height="14"></td>
    <td height="20" align="center" valign="top" class="SLOGAN_BLACK"><b><?php   echo TEXT_NEW;?></b></td>
    <td rowspan="2" background="<?php   echo DIR_WS_IMAGES;?>img_recom/right_line_recom.gif"><img src="<?php   echo DIR_WS_IMAGES;?>blank.gif" width="14" height="14"></td>
  </tr>
  <tr>
    <td>
		<?php  
...
//BEN001			$listing_sql .= ' left join products_description_adult pd on p.products_id = pd.products_id and pd.language_id=' . $languages_id ;
			...
			$listing_sql .= ' and products_status>0 ';
		...
		?>
			<div align="center"><a href="<?php   echo tep_href_link('listing_category_adult.php', 'list=new');?>" class="dvdpost_brown_underline"><?php  echo TEXT_VIEW_ALL;?></a></div>
        </td>
  </tr>
  <tr>
