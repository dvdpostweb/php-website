...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>
		...
		$series_query = tep_db_query("select p.products_id, pd.products_name from " . TABLE_PRODUCTS . " p left join " . TABLE_PRODUCTS_DESCRIPTION . " pd on p.products_id = pd.products_id where p.products_series_id = '" . $product_info_values['products_series_id'] . "' and pd.language_id = '" . $languages_id . "' and products_type = 'DVD_NORM' order by products_series_number "); //BEN001
