<?php 
//queries language
$sql="select l.products_languages_id from " . TABLE_PRODUCTS_TO_LANGUAGES. " l where l.products_id = '" . $product_info_values['products_id'] . "'";

$languages_query = tep_db_query($sql);
