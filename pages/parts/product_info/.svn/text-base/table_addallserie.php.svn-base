...
if ($product_info_values['products_series_id']>0) {
	echo '<table width="200"  border="0" cellspacing="0" cellpadding="0" align="left"><tr><td align="center">';
	if (tep_session_is_registered('customer_id')) {
	  ...
	  ?><a href="registerforrent.php?products_id=<?php  echo $product_info_values['products_id']; ?>"><img border="0" src="<?php  echo DIR_WS_IMAGES_LANGUAGES . $language ?>/images/buttons/button_addall_serie.gif"></a>
      <?php 
	}
	echo '</td></tr></table>';
