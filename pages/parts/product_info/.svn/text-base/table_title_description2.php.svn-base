<table width="380" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 ?>
  ...
  <tr valign="middle" bgcolor="#F2F2F2">
    <td colspan="3" align="left" class="TYPO_STD_BLACK_bold"><img src="<?php   echo DIR_WS_IMAGES;?>blank.gif" width="14" height="3" align="absmiddle"><?php   echo TEXT_DVDZONE2;?><img src="<?php   echo DIR_WS_IMAGES;?>blank.gif" width="20" height="3" align="absmiddle">
      <?php  
			   switch ($languages_id){
				 case 1:
				   echo '<a href="http://www.dvdzone2.com/affiliate.asp?aid=100662&afflang=fra&redirect=%2Fdvd%2Fsearch%2Easp%3Ft%3D1%26kw%3D'. substr($product_info_values['products_name'], 0, 9) .'%26kwt%3Dt%26pl%3Dfra" target = new><img src="' . DIR_WS_IMAGES . '/logo_dvdz2.gif" align="absmiddle" border=0></a>';
				 break;
				 case 2:
				   echo '<a href="http://www.dvdzone2.com/affiliate.asp?aid=100662&afflang=nld&redirect=%2Fdvd%2Fsearch%2Easp%3Ft%3D1%26kw%3D'. substr($product_info_values['products_name'], 0, 9) .'%26kwt%3Dt%26pl%3Dnld" target = new><img src="' . DIR_WS_IMAGES . '/logo_dvdz2.gif" align="absmiddle" border=0></a>';
				 break;
				 case 3:
				   echo '<a href="http://www.dvdzone2.com/affiliate.asp?aid=100662&afflang=eng&redirect=%2Fdvd%2Fsearch%2Easp%3Ft%3D1%26kw%3D'. substr($product_info_values['products_name'], 0, 9) .'%26kwt%3Dt%26pl%3Dall" target = new><img src="' . DIR_WS_IMAGES . '/logo_dvdz2.gif" align="absmiddle" border=0></a>';
				 break;
			   }
			 ?>
</td>
