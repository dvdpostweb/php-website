...
//echo $listing_sql;
  //if ($listing_numrows = 0) {  
	...
	$listing_sql='SELECT p.products_id,p.products_sale_date , pd.products_name, pd.products_image_big, p.products_sale_price , p.products_language_fr, p.products_undertitle_nl ';
	...
	if ($x!=0 && $x<97){
		$listing_sql.=' ORDER  BY  p.products_date_available  DESC  LIMIT '.$x.','.$limit ;}
	else{
		$x=0;
		$listing_sql.=' ORDER  BY  p.products_date_available  DESC  LIMIT '.$x.','.$limit ;}
...
<table width="542" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="309" background="<?php  echo DIR_WS_IMAGES;?>shop/titlebar/box/title_mid.gif" class="dvdpost_left_menu_title_shop" align="left"><b><?php  echo $count.'</b> '.TEXT_MATCHING_SEARCH.' <b>'.$search_title.'</b>' ?></td>
		...
		<table width="100%" align="center" cellpadding="0" cellspacing="0">
		  <tr>
			<td>
				<br>
					<?php 							
					echo '<table width="520" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr>';
					while ($product_info_values = tep_db_fetch_array($listing)) {
						...
						<form name="form1" method="post" action="addtoshoppingcart_public.php">							
							<table width="213" border="0" align="center" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td>
										<TABLE width="102" border="0" cellpadding="0" cellspacing="0"  align="center">										
										    ...
										    <TR>
												<TD WIDTH="87" HEIGHT="130" valign="top"><a href="product_info_shop.php?products_id=<?php  echo $product_info_values['products_id'].'"><img src="'.DIR_DVD_WS_IMAGES.$product_info_values['products_image_big'] ;?>" border="0" WIDTH="87" HEIGHT="130" ALT="<?php  echo $product_info_values['products_name'] ;?>"></a></TD>
											</TR>
											<TR>
								...
								<tr>
									<td align="center">
									  <a href="product_info_shop.php?products_id=<?php  echo $product_info_values['products_id'] ;?>"><img src="<?php  echo DIR_WS_IMAGES_LANGUAGES.$language;?>/images/buttons/button_buy.gif" border="0"></a>
									</td>
								</tr>
							</table>
						</form><br>
