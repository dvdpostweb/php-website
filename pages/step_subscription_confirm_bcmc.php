<table width="731" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr> 
    <td width="244" rowspan="4" align="center" valign="bottom" class="limitedtitle"> 
    ...
    <td width="463" align="left" valign="middle" class="TYPO_NUM_BLACK"><b><?php  echo TEXT_SUBSCRIPTION ;?></b></td>
  ...
  <?php  
  include(getBestMatchToInclude(DIR_WS_COMMON . 'includes/step/step_subscription_confirm_bcmc_form.php'));  
  ?>
  <tr> 
