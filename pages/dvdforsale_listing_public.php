<table width="730" align="center" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td  valign="middle" align="right"><?php  echo '<a class="red_slogan" href="dvdforsale_info_public.php"><u>' . HEADING_HELP . '</u></a>'; ?></td>
  </tr>
    <tr>
    <td  height="6" colspan="2" valign="top"><div align="center"><img src="<?php  echo DIR_WS_IMAGES;?>line-it.jpg" width="730" height="6"></div></td>
  </tr>
</table>
<br>
<?php 
		...
		?>
 		<td>			
		  <table border="0" align="center" width="300" height="150"cellspacing="0" cellpadding="0" background="<?php  echo DIR_WS_IMAGES;?>shop/shopping_bckg.gif">
		    <tr>
		      <td width="122" rowspan="7" align="center"><div align="center"><a href="product_info_public.php?products_id=<?php  echo $product_info_values['products_id'];?>"><img src="<?php  echo $constants['DIR_DVD_WS_IMAGES'].'/'. $product_info_values['products_image_big'] ;?>" border="0" width="80" height="120"></a></div></td>
		      <td width="178"></td>
		    </tr>
		    <tr>
		    ...
		    <tr>
		      <td ><a href="product_info_public.php?products_id=<?php  echo $product_info_values['products_id'];?>" class="basiclink"><u><?php  echo TEXT_MORE_INFO ;?></u></a></td>
		    </tr>
		    <tr>
		    ...
		    <tr>
			  ...
			  <a href="addtoshoppingcart_public.php?products_id=<?php  echo $product_info_values['products_id'];?>" class="basiclink"><img src="<?php  echo  DIR_WS_IMAGES_LANGUAGES.$language;?>/images/buttons/button_add_to_shopping_cart.gif" border="0"></a>
			  </td>
		    </tr>
		  </table>
			<br>
