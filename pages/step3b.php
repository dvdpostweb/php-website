								...
								<fieldset>
									<table class='step2form' cellpadding="2" cellspacing="0" border="0" align="center" width="100%">
										<tr>
											...
											<td align="left" class="explain_text_gender" width='260'>
									...
									<td align="left" class="explain_text" width='160'></td>
								</tr>
	...
	<td colspan='2'>
		...
		<table cellpadding="2" class="padding_button">
			<tr>
				...
				<td>
					<input type="submit" name ="sent" value= "<?= SUBMIT ?>" class="step31_image" />
				</td>
			</tr>
		</table>
	</td>
...
<tr>
	<td colspan="2"><div id="step3_footer"><? $promo_footer; ?> </div></td>
</tr>
</table>
</div>
