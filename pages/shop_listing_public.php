...
$cPath=intval($cPath);	
	if ($cPath >0){
		...
		if ($cPrice  >0){
			$query_count .=' AND p.products_sale_price =  '. $cPrice.' ';
			$query_list .=' AND p.products_sale_price =  '. $cPrice.' ';
...
<table width="560" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="379" background="<?php  echo DIR_WS_IMAGES;?>shop/titlebar/box/title_mid.gif" class="dvdpost_left_menu_title_shop" align="left"><b><?php  echo $count.'</b> '.TEXT_MATCHING_SEARCH.' <b>'.$search_title.'</b>' ?></td>
  ...
  <tr>
    ...
    <td colspan="3">
		...
		<?php 
					...
					echo '<table width="100%" height="150"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr>';
