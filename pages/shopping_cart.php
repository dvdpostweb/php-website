...
if ($total_count >0) {
?>
  <form name="form1" action="shoppingcartupdate.php" method="post">
  		<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
    	  <tr align="center">
		 		...
		 		<?php 
		 			if (!tep_session_is_registered('customer_id') ||$customers_registration_step<10 ){
						...
						$sc_query = tep_db_query("select * from shopping_cart sc left join products p on sc.products_id = p.products_id left join " . TABLE_PRODUCTS_DESCRIPTION . " pd on pd.products_id = sc.products_id and pd.language_id='" . $languages_id . "' where ((p.products_type = 'DVD_NORM' and p.products_product_type= 'Movie') or ( p.products_type='BUY')) and sc.customers_id = '" . $customer_id . "' and sc.products_id > 0"); //BEN001
		      			...
		      			$sc_query = tep_db_query("select * from shopping_cart sc left join shopping_box sb on sc.shopping_box_id = sb.shopping_box_id left join shopping_box_description sbd on sbd.shopping_box_id = sc.shopping_box_id and sbd.language_id='" . $languages_id . "' where sc.customers_id = '" . $customer_id . "' and sb.shopping_box_id>0 ");
  ...
  <form name="form2" action="shopping_cart_checkout.php" method="post">
  <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	<td width="48%" valign="top">
		...
		<?php  
		  ...
		  echo '<tr><td  valign="middle" height="30" align="left"><a href="shopping_cart.php?w_faq=1" class="dvdpost_left_menu_link1_shop"><u>'.TEXT_SHOPPING_FAQ_Q1.'</u></a></td></tr>';
		  } 
		  if ($w_faq==2){
		  ...
		  echo '<tr><td  valign="middle" height="30" align="left"><a href="shopping_cart.php?w_faq=2" class="dvdpost_left_menu_link1_shop"><u>'.TEXT_SHOPPING_FAQ_Q2.'</u></a></td></tr>';
		  }
		  if ($w_faq==3){
		  ...
		  echo '<tr><td  valign="middle" height="30" align="left"><a href="shopping_cart.php?w_faq=3" class="dvdpost_left_menu_link1_shop"><u>'.TEXT_SHOPPING_FAQ_Q3.'</u></a></td></tr>';
		  }
		  ?>
		  </table>
	</td>
