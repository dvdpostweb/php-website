  ...
  <tr>
    <td class="SLOGAN_DETAIL">
			...
			if ($customers[customers_abo_type] > 0){
				...
				echo '<br>';
	            echo TEXT_STOP; 
				echo '<div align="center"><a href="' . FILENAME_SUBSCRIPTIONSTOP_CONFIRM . '?products_id=0"><img src="' . DIR_WS_IMAGES_LANGUAGES . $language . '/images/buttons/stop.gif' .'" border = 0 alt="STOP"></a></div>';
			}else{
				echo TEXT_NOABO;
			}		
			?>
