...
.cinenews {
background:url(<?php echo DIR_WS_IMAGES_LANGUAGES.$language.'/images/philips/home.jpg' ;?>);
...
<form name="form1" method="post" action="activation_code_confirm.php">
				...
				<div id="cinenews_dvd"><img src="<?php echo DIR_WS_IMAGES_LANGUAGES.$language ;?>/images/philips/home.jpg"></div>
			  	<div id="promocode">
                <p><?php echo TEXT_PHILIPS_EXPLAIN ;?></p>
                  ...
                  <p class="footer_actu"><?php echo TEXT_LOREAL_FOOTER ;?></p>
                </div>      
