<table width="731" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td  class="SLOGAN_DETAIL"> <br>
        <?php  echo str_replace('faq.php','faq_public.php',INTRO); ?> </td>
  </tr>
  	<td align="center" class="SLOGAN_DETAIL">
  		<br>
    	<a href="custserv_public.php"><img border=0 src="<?php  echo DIR_WS_IMAGES_LANGUAGES . $language;?>/images/buttons/custserv_question.gif"></a>
  	    <br><br>
	</td>
  </tr>
  <tr>
	  	...
	  	<TD colspan="5" bgcolor="#FFFFFF">
			<table width="100%">
				...
				while ($custserv = tep_db_fetch_array($custserv_query)){
					...
					echo '<td width="100">';
					echo '<a class="red_slogan" href="custserv_detail_public.php?custserv_id=' . $custserv['custserv_id'] . '"><u>' . $custserv['custserv_id'] . '</u></a>';	           
					echo '</td>';	           
					...
					echo '</td>';	           
					echo '<td class="SLOGAN_BLACK" width="80">';
					echo '<a class="red_slogan" href="custserv_detail_public.php?custserv_id=' . $custserv['custserv_id'] . '" ><img src="' . DIR_WS_IMAGES . '/detailcustserv.gif" bordercolor="white" border="0"></a>';
					echo '</td>';	           
					echo '</tr>';	           
				} 	
        	?>
