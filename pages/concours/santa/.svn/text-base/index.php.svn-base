...
<table width="950" align="center" border="0" cellspacing="0" cellpadding="0" bgcolor='#FFFFFF' >
  <tr>
    <td ><h1><?php  echo TEXT_SANTA_TITLE; ?></h1></td>
  ...
  <tr>
   ...
   <img src="<?php echo DIR_WS_IMAGES_LANGUAGES.$language.'/images/santa/prix.jpg' ;?>" />
    <p align="right"><?php echo TEXT_SANTA_REGLEMENT ;?></p></td>
  </tr>
