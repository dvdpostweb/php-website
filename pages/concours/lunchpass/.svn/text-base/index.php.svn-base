...
<table width="950" align="center" border="0" cellspacing="0" cellpadding="0" bgcolor='#FFFFFF' >
  <tr>
    <td ><h1><?php  echo TEXT_LUNCHPASS_TITLE; ?></h1></td>
    <td valign="top"><img src="<?php echo DIR_WS_IMAGES_LANGUAGES.$language.'/images/lunchpass/lunchpass_logo.gif' ;?>" /></td>
  </tr>
  <tr>
  <tr>
   ...
   <img src="<?php echo DIR_WS_IMAGES_LANGUAGES.$language.'/images/LUNCHPASS/prix.jpg' ;?>" />
	 <p align="center"><?php echo TEXT_LUNCHPASS_EXPLAIN ;?></p>
    <p align="right"><?php echo TEXT_LUNCHPASS_REGLEMENT ;?></p></td>
  </tr>
  <tr>
  <td colspan="2"><p align="center"><?php echo TEXT_LUNCHPASS_FOOTER ;?></p></td>
  </tr>
</table>
