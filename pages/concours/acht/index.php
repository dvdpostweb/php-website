...
<table width="950" align="center" border="0" cellspacing="0" cellpadding="0" bgcolor='#FFFFFF' >
  <tr>
    <td class="title_acht"><h3><?php  echo TEXT_ACHT_TITLE; ?></h3></td>
    <td valign="top"><img src="<?php echo DIR_WS_IMAGES_LANGUAGES.$language.'/images/acht/acht_logo.gif' ;?>" /></td>
  </tr>
  <tr>
  <tr>
   ...
   <img src="<?php echo DIR_WS_IMAGES_LANGUAGES.$language.'/images/acht/prix.jpg' ;?>" />
	 <p align="center"><?php echo TEXT_ACHT_EXPLAIN ;?></p>
    <p align="right"><?php echo TEXT_ACHT_REGLEMENT ;?></p></td>
  </tr>
  <tr>
  <td colspan="2"><p align="center"><?php echo TEXT_ACHT_FOOTER ;?></p></td>
  </tr>
</table>
