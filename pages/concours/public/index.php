...
<table width="950" align="center" border="0" cellspacing="0" cellpadding="0" bgcolor='#FFFFFF' >
  <tr>
    <td><h1><?php  echo TEXT_PUBLIC_TITLE; ?></h1></td>
    <td valign="top"><img src="<?php echo DIR_WS_IMAGES_LANGUAGES.$language.'/images/public/dvdpost_logo.gif' ;?>" /></td>
  </tr>
  <tr>
  <tr>
   ...
   <img src="<?php echo DIR_WS_IMAGES_LANGUAGES.$language.'/images/public/prix.jpg' ;?>" />
	 <p align="center"><?php echo TEXT_PUBLIC_EXPLAIN ;?></p>
    <p align="right"><?php echo TEXT_PUBLIC_REGLEMENT ;?></p></td>
  </tr>
  <tr>
  <td colspan="2"><p align="center"><?php echo TEXT_PUBLIC_FOOTER ;?></p></td>
  </tr>
</table>
