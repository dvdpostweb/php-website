...
?>
<link href="http://private.dvdpost.com/stylesheets/reconductions.css?1322739542" media="all" rel="stylesheet" type="text/css" />
</head>
  ...
  <div class="relance">
    ...
    <div align="center">
		<form name="form1" method="post" action="activation_code_confirm.php" align="center">
			<input name="code" id="code" type="hidden"  value="BGCNEW">
			<input  class="button_relance" type="submit" name=sent value="<?= TRY_US ?>">
		</form>
		</div>
