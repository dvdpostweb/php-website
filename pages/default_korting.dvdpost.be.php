...
<div class="main-holder">
	<form name="form1" method="post" action="activation_code_confirm.php">
	  <div id="cinenews_dvd"><img src="<?php echo DIR_WS_IMAGES_LANGUAGES.$language ;?>/images/header_korting.jpg"></div>
	  <div id="promo">
	    <div id="promo_area">
	    ...
	    <div class="clear"></div>
	    <p class="footer_actu"><?= TEXT_KORTING ?> | <a href="/conditions.php"><strong><?= TEXT_CONDITION_SUMMER ?></strong></a></p>
