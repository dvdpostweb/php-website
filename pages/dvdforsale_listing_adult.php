...
//echo $listing_sql;
  //if ($listing_numrows = 0) {
	...
	$listing_sql='SELECT p.products_id , pd. products_name , p.products_runtime , p.products_year , p.products_rating , pd.products_image_big ,p.products_sale_price ';
//BEN001	$listing_sql.=' FROM  products_adult p ,  products_description_adult pd ';
	...
	$listing_sql.=' ORDER BY `products_sale_price` ASC ';
    ...
    while ($product_info_values = tep_db_fetch_array($listing)) {
		...
		<form name="form1" method="post" action="addtoshoppingcart_adult.php">
		  <table border="0" align="center" width="300" height="150"cellspacing="0" cellpadding="0" background="<?php  echo DIR_WS_IMAGES;?>shop/shopping_bckg.gif">
		    <tr>
		      <td width="122" rowspan="7" align="center"><div align="center"><a href="product_info_adult.php?products_id=<?php  echo $product_info_values['products_id'];?>"><img src="'.$constants['DIR_WS_IMAGESX'].'/<?php  echo $product_info_values['products_image_big'] ;?>" border="0" width="80" height="130"></a></div></td>
		      <td width="178"></td>
		    </tr>
		    <tr>
