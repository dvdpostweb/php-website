  ...
  <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="<?php  echo $bgcolor;?>">
    <tr>
      <td><table width="<?php  echo SITE_WIDTH_PUBLIC; ?>" height="631" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#E3E3E3">
        ...
        <tr>
          <td width="65" height="50" align="right" valign="middle" class="SLOGAN_GRIS_13px">2 <?php  echo TEXT_MONTHS; ?> </td>
          <td width="34" height="50" align="center" valign="middle"><img src="<?php  echo DIR_WS_IMAGES;?>prepay/arrow.gif"></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td height="50" align="right" valign="middle" class="SLOGAN_GRIS_13px">3 <?php  echo TEXT_MONTHS ;?> </td>
        ...
        <tr>
          ...
          <td width="448" height="169"><table width="420" height="169" border="0" cellpadding="0" cellspacing="0" background="<?php  echo DIR_WS_IMAGES;?>prepay/promo.jpg" class="promo_freetrial">
              ...
              <tr>
                <td width="221" height="43" align="left" valign="middle"><a href="freetrial.php"><img src="<?php  echo DIR_WS_IMAGES;?>/languages/<?php  echo $language ;?>/images/buttons/button_try.jpg" width="209" height="33" border="0"></a></td>
              </tr>
              <tr>
          ...
          <td width="116"><?php  include(getBestMatchToInclude(DIR_WS_COMMON . 'includes/formula/prepay/basic.php'));?>
          </td>
          <td rowspan="3">&nbsp;</td>
        </tr>
        <tr>
