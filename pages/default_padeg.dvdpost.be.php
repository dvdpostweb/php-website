...
.cinenews {
background:url(<?php echo DIR_WS_IMAGES_LANGUAGES.$language.'/images/padeg/home.jpg' ;?>);
...
<form name="form1" method="post" action="activation_code_confirm.php">
				...
				<div id="cinenews_dvd"><img src="<?php echo DIR_WS_IMAGES_LANGUAGES.$language ;?>/images/padeg/home.jpg"></div>
			  	<div id="promocode">
                <p><?php echo TEXT_PADEG_EXPLAIN ;?></p>
