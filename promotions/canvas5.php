...
<div id="facebox" style="top: 72.7px; margin:auto 0; ">   <div class="popup">       <table>         <tbody>           <tr>             <td class="tl"></td><td class="b"></td><td class="tr"></td>           </tr>           <tr>             <td class="b"><div class="ten"></div></td>             <td class="body">               <div class="content" style="display: block; ">
  ...
  <div style="width:400px;margin:25px">
    <h2><?= TEXT_EMAIL_TITLE ?></h2>
    <br><br>
    <form id="sub_email">
      <?= TEXT_EMAIL_LABEL ?> : <input name="email" id="input_email" type="text">
      <input type='hidden' name='source' value='<?= $source ?>'>
      <input type='hidden' name='imdb_id' value='<?= $imdb_id ?>'>
      <input type="submit" id="sub">
      <div class='error' id='error3' style='display:none'><?= TEXT_EMAIL_ERROR1 ?></div>
      <div class='error' id='error2' style='display:none'><?= TEXT_EMAIL_ERROR2 ?></div>
      <div class='error' id='error1' style='display:none'><?= TEXT_EMAIL_ERROR3 ?></div>
      </form>
      <br><br>
  </div>
