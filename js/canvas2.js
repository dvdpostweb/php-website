$(function() {
  ...
  error_email = true;
  $('#form_step #password, #form_step2 #password2').keyup(function() {
  ...
  $('#form_step #submit_id,#form_step2 #submit_id2').click(function() {
  ...
  $('#form_step #email, #form_step2 #email2').blur(function() {
