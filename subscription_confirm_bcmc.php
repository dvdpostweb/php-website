...
$current_page_name = 'subscription_confirm_bcmc.php';
...
if ($customers[customers_abo] > 0){
  ...
  if ($HTTP_POST_VARS['products_id'] <> 2){
	  ...
	  if ($HTTP_POST_VARS['discount_code'] =='BCC06' or $HTTP_POST_VARS['discount_code'] =='bcc06') {
	    tep_redirect(tep_href_link('subscription_info_bcmc.php?products_id=2', '', 'SSL'));	  
	  }	  
	  if ($HTTP_POST_VARS['discount_code'] =='3TBASIC' or $HTTP_POST_VARS['discount_code'] =='3tbasic') {
	    tep_redirect(tep_href_link('subscription_info_bcmc.php?products_id=2&discount_code=3TBASIC', '', 'SSL'));	  
	  }	 
 ...
 if ($HTTP_POST_VARS['products_id'] < 6){
  ...
  if (strlen($HTTP_POST_VARS['payment']) < 1) {
	tep_redirect(tep_href_link('subscription_info_bcmc.php?error=1&products_id=' . $HTTP_POST_VARS['products_id'] , '', 'SSL'));	  
  }
  ...
  if (($final_price) == 0) {
	tep_redirect(tep_href_link('subscription_info_bcmc.php?error=2&products_id=' . $HTTP_POST_VARS['products_id'] . '&discount_code_id=' . $HTTP_POST_VARS['discount_code_id'], '', 'SSL'));	  
  }
