							...
							if ($customers[customers_abo] > 0){
								...
								if ($customers['domiciliation'] > 0){
									...
									if ($customers[domiciliation_status]>0){
										...
										?>
											<form name="subbcmc" action="step_subscription_confirm_bcmc.php" method="post">
											<p>
											...
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
												<tr>													
													...
													<td class="step_title" valign="middle" align="center">
														<?php  					                            
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<tr>							                  
							                  <td  colspan="2" class="step_title" height="35" valign="middle"><B><?php   echo TEXT_SUB_PAY_METHOD ;?></B> (<a class="infolink" href="payment.php"><?php  echo TEXT_MORE_INFO;?></a>)</td>							                  
							                </tr>
												<?php  
											...
											?>
				                            <tr>
				                              <td class="step_title" height="25" valign="middle"><b><?php   echo TEXT_BCMC; ?></b></td>
				                              <td class="step_title" height="25" valign="middle"><input type="radio" name="payment" value="bcmc"></td>
				                            </tr>
				                            <tr>
				                              <td class="step_title" height="25" valign="middle"><b><?php   echo TEXT_INGHOMEPAY; ?></b></td>
				                              <td class="step_title" height="25" valign="middle"><input type="radio" name="payment" value="inghomepay"></td>
				                            </tr>
				                            <tr>
				                              <td class="step_title" height="25" valign="middle"><b><?php   echo TEXT_CBCONLINE; ?></b></td>
				                              <td class="step_title" height="25" valign="middle"><input type="radio" name="payment" value="cbconline"></td>
				                            </tr>
				                            <tr>
				                              <td class="step_title" height="25" valign="middle"><b><?php   echo TEXT_DEXIANETBANKING; ?></b></td>
				                              <td class="step_title" height="25" valign="middle"><input type="radio" name="payment" value="dexianetbanking"></td>
				                            </tr>
				                            <tr>
				                              <td class="step_title" height="25" valign="middle"><b><?php   echo TEXT_KBCONLINE; ?></b></td>
				                              <td class="step_title" height="25" valign="middle"><input type="radio" name="payment" value="kbconline"></td>
				                            </tr>
											<?php  } ?>
				                            <tr>
				                              <td class="step_title" height="25" valign="middle" colspan="2">
				                              <a class="infolink" href="step_subscription_info_dom.php?products_id=<?php   echo $HTTP_GET_VARS['products_id'];?>&discount_code_id=<?php   echo $HTTP_GET_VARS['discount_code_id'];?>"><?php   echo TEXT_LINK_DOM; ?></a>
				                              </td>
				                            </tr>
				                            <tr>
				                              <td class="step_title" height="25" valign="middle" colspan="2">
				                              <a class="infolink" href="step_subscription_info.php?products_id=<?php   echo $HTTP_GET_VARS['products_id'];?>&discount_code_id=<?php   echo $HTTP_GET_VARS['discount_code_id'];?>"><?php   echo TEXT_LINK_CC; ?></a>
				                              </td>
				                            </tr>											
										</table>										
										<br>
