						...
						?>
						  ...
						  <td height="20" align="center" valign="top">							
								...
								<input  TYPE="hidden" VALUE="<?php  echo $check_discount_values['discount_code_id'] ;?>" NAME="activation_discount_code_id">
          						<input  TYPE="hidden" VALUE="<?php  echo $check_discount_values['discount_code'] ;?>" NAME="activation_code">
          					<input name="submit" type="image" src="<?php  echo DIR_WS_IMAGES ;?>languages/<?php  echo $language ;?>/images/buttons/button_subscribe_2.gif" border="0" value="submit">
						   </td>
						  </form>
						<?php  }else{
						?>
