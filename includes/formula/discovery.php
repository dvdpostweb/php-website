...
<table width="105" border="0" cellpadding="0" cellspacing="0" bgcolor="#E5E5E5">
  <tr>
    <td height="30" align="center" valign="bottom"><?php  echo TEXT_ABO_DISCOVERY;?></td>
  </tr>
  <tr>
    <td height="36" align="center"><img src="<?php  echo DIR_WS_IMAGES;?>dvd_three.jpg" width="53" height="22" align="top"></td>
  </tr>
  <tr>
    <td width="105" height="42" align="center" valign="top"class="TYPO_STD2_GREY">
		<?php  echo TEXT_ABO_DISCOVERY_EXPLANATION;?>
	</td>
  </tr>
		<?php 
		switch ($current_page_name) {
		   case 'summersales.php':
			   $show_abo_price= '<del>'. TEXT_ABO_DISCOVERY_PRICE .'</del><br>14.98€';
			   break ;	
		   case 'dvd50foryou.php':
			   $show_abo_price= '<del>'. TEXT_ABO_DISCOVERY_PRICE .'</del>';
			   break ;		
		   case 'starwars.php':
			   $show_abo_price= '<del>'. TEXT_ABO_DISCOVERY_PRICE .'</del>';
			   break ; 
		   ...
		   case 'versavenir2.php':
			   ...
			   break ;
		   case '2months25.php':
			   $show_abo_price= '<del>'. TEXT_ABO_DISCOVERY_PRICE .'</del><br><span class="dvdp_st2"><b>22.46€</b></span>';
			   break ;
		   case 'subscription_info.php':
			   $show_abo_price='';	
			   break ;  
		   default:
			   $show_abo_price= TEXT_ABO_DISCOVERY_PRICE;
			   break;
	   }
