		...
		if($query_mgm_value = tep_db_fetch_array($query_mgm)) 
		{
			if($query_mgm_value['mem_get_mem_id']>0)
			{
				...
				if ($father_value['customers_abo']>0)
				{
					...
					tep_db_query("insert into mem_get_mem_used (date, father_id, father_abo_type, son_id , son_abo_type , points ) values (now(), '" . $query_mgm_value['customers_id'] . "', '" . $father_value['customers_abo_type'] . "', '" . $son_id . "', '" . $products_id. "', '0' )");	    	    				
