...
// class constructor
    function payment() {
      ...
      if (MODULE_PAYMENT_INSTALLED) {
        $this->modules = explode(';', 'ogone.php;bbl.php;cbc.php;dexia.php;kbc.php'); // get array of installed/active modules
    ...
    function pre_confirmation_check() {
      ...
      if (MODULE_PAYMENT_INSTALLED) {
        ...
        if (!$payment_module_selected) {
          tep_redirect(tep_href_link(FILENAME_CHECKOUT_PAYMENTCCHB, 'error_message=' . urlencode(ERROR_NO_PAYMENT_MODULE_SELECTED), 'SSL'));
        }
      }
    }
