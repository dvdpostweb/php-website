...
if (!isAdult($HTTP_POST_VARS['products_id'])){
		...
		$sql_addtowishlist  = " insert into " . TABLE_WISHLIST . " select null, c.customers_id, '" . $HTTP_POST_VARS['products_id'] . "', ifnull(w1.rank,0)+1," . $HTTP_POST_VARS['priority'] . ", now(), 'DVD_ADULT', 1 "; //BEN001
		...
		//$sql_addtowishlist .= " and w1.wishlist_type = 'DVD_ADULT' "; //BEN001
