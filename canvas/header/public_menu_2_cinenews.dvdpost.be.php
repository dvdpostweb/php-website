<?php    
 ...
 $button_how='<a href="http://www.dvdpost.be/how.php"><img src="'.DIR_WS_IMAGES.'languages/'.$language.'/images/buttons/inactive/how.png" border="0" alt="'.TEXT_HOW_DOES_IT_WORK.'"></a>' ;
 $button_catalog='<a href="http://www.dvdpost.be/catalog.php"><img src="'.DIR_WS_IMAGES.'languages/'.$language.'/images/buttons/inactive/catalog.png" border="0" alt="'.TEXT_CATALOG.'"></a>' ;
