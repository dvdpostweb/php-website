<?php 
 ...
 {?>
 <table name="homepage_menu_ACTIVE-PASSIVE"width="770"  border="0" align="center" cellpadding="1" cellspacing="1" >   
  	<tr align="left">
      ...
      <td width="120" class="TAB_button_try"><a href="/<?php  echo $link ;?>" class="typo_menu"><?php echo $step_text;?></a><img src="<?php  echo DIR_WS_IMAGES;?>/blank.gif" width="6" height="3"></div></td>
      <td width="69" nowrap background="<?php  echo DIR_WS_IMAGES;?>telemoustique/nuancier.gif"><img src="<?php  echo DIR_WS_IMAGES;?>/blank.gif" width="6" height="3"></td>
    </tr>
</table>
<?php 
  }
