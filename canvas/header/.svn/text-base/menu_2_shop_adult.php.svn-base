...
<tr align="left" valign="bottom">
	...
	<?php  
		...
		echo '<td width="170" class="TAB_MENU_ACTIVE_ADULT">';
    ...
    <td width="410" bgcolor="#757575">
		<table border="0" align="right" cellpadding="0" cellspacing="0">
			<tr>
				<td background="<?php  echo DIR_WS_IMAGES;?>/bckg_2_shop_adu.gif"><img src="<?php  echo DIR_WS_IMAGES;?>/blank.gif" width="210" height="3" align="left"></td>
				<td align="center" valign="middle" class="TAB_nuancier_x" background="<?php  echo DIR_WS_IMAGES;?>/nuancier_shop_adult.jpg"><img src="<?php  echo DIR_WS_IMAGES;?>/blank.gif" width="200" height="3" align="left"></td>
			</tr>
	  </table>	
	</td>
  </tr>
