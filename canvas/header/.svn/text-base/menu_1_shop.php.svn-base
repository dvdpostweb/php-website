...
?>
 <table width="960" border="0" align="center" cellpadding="0" cellspacing="0" background="<?php  echo DIR_WS_IMAGES;?>dvdpost_background_shop.gif" class="TAB_MENU_GREY" name="homepage_menu_grey">
  	<tr>
