<?php 
 ...
 {?>
 <table name="homepage_menu_ACTIVE-PASSIVE" width="786"  border="0" align="center" cellpadding="1" cellspacing="1" >   
  	<tr align="left">
      ...
      <td width="69" nowrap background="<?php  echo DIR_WS_IMAGES;?>/msn/nuancier_msn.gif"><img src="<?php  echo DIR_WS_IMAGES;?>/blank.gif" width="6" height="3"></td>
    </tr>
</table>
<?php 
  }
