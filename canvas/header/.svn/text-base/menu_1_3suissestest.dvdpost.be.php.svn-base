   <table name="homepage_menu_grey" width="<?php  echo SITE_WIDTH_PUBLIC;?> " border="0" cellpadding="0" cellspacing="0" bgcolor="#5AA8DA" class="TAB_MENU_GREY">
   <tr>
	<?php  
		switch($languages_id){
		case 1:
			echo '<td align="left" width="66"><a href="' . tep_href_link($PHP_SELF, 'language=nl') . '" class="basiclink_menu"> NL</a></td>';
		break;
		case 2:
			echo '<td align="left" width="66"><a href="' . tep_href_link($PHP_SELF, 'language=fr') . '" class="basiclink_menu"> FR</a></td>';					
		break;
		case 3:
			echo '<td align="left" width="66"><a href="' . tep_href_link($PHP_SELF, 'language=nl') . '" class="basiclink_menu"> NL</a>';
			echo ' - ';
			echo '<a href="' . tep_href_link($PHP_SELF, 'language=fr') . '" class="basiclink_menu"> FR</a></td>';
		break;
		}
	?>
