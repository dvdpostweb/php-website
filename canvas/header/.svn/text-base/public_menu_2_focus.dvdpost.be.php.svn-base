<style>
	.public.td {margin: 0px 0px 0px 0px !important;}
</style>
<?php    
...
?>
 <table border="0" cellspacing="0" cellpadding="0" height="30" align="center">
	<tr valign="bottom"> 
	  <td valign="bottom" height="30" width="95" ><?php   echo $button_home ;?></td>
	  <td width="5" "bottom"><img src="<?php    echo DIR_WS_IMAGES;?>canvas/bl_line.gif" width="6" height="30"></td>
	  <td width="149" valign="bottom" height="30"><?php   echo $button_how ;?></td>
	  <td width="5" "bottom"><img src="<?php    echo DIR_WS_IMAGES;?>canvas/bl_line.gif" width="5" height="30"></td>
	  <td width="114" valign="bottom" height="30"><?php   echo $button_catalog ;?></td>
	  <td width="316" "bottom"><img src="<?php    echo DIR_WS_IMAGES;?>canvas/bl_line.gif" width="315" height="30"></td>
	  <td width="88" valign="bottom" height="30"><?php   echo $button_shop ;?></td>
	</tr>
 </table>
<?php 
}else{
?>
 <table width="773" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr> 
	  <td width="95" valign="bottom" height="30"><?php   echo $button_home ;?></td>
	  <td width="5" "bottom"><img src="<?php    echo DIR_WS_IMAGES;?>canvas/bl_line.gif" width="6" height="30"></td>
	  <td width="149" valign="bottom" height="30"><?php   echo $button_how ;?></td>
	  <td width="5" "bottom"><img src="<?php    echo DIR_WS_IMAGES;?>canvas/bl_line.gif" width="5" height="30"></td>
	  <td width="114" valign="bottom" height="30"><?php   echo $button_catalog ;?></td>
	  <td width="5" "bottom"><img src="<?php    echo DIR_WS_IMAGES;?>canvas/bl_line.gif" width="5" height="30"></td>
	  <td width="117" valign="bottom" height="30"><?php   echo $button_try ;?></td>
	  <td width="193" "bottom" background="<?php    echo DIR_WS_IMAGES;?>canvas/bl_line.gif"><img src="<?php    echo DIR_WS_IMAGES;?>canvas/bl_line.gif" width="6" height="30"></td>
	  <td width="88" valign="bottom" height="30"><?php   echo $button_shop ;?></td>
	</tr>
 </table>
<?php 
