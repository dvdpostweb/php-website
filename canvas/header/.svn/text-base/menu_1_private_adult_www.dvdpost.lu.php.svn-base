...
?> 
  <table width="960" border="0" align="center" cellpadding="0" cellspacing="0" background="<?php  echo DIR_WS_IMAGES;?>dvdpost_background_adultlu.gif" class="TAB_MENU_GREY" name="homepage_menu_grey">
  	<tr>
		<td width="723" rowspan="2"><a href="mydvdxpost.php"><img src="<?php  echo DIR_WS_IMAGES;?>/blank.gif" width="300" height="35" border="0" align="absmiddle"></a></td>
		<?php  
		switch($languages_id){
		case 1:			
