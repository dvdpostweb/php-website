<?php 
  require(SITE_ID . '/headerrtl4.php'); 
  require(SITE_ID . '/headerrtlbox.php'); 
...
// check session.auto_start is disabled
  ...
  include(getBestMatchToInclude(DIR_WS_COMMON . 'canvas/header/menu_1.php'));
  include(getBestMatchToInclude(DIR_WS_COMMON . 'canvas/header/menu_2.php'));
