...
<body id="hp" class="normal" >
	...
	//echo 'type'.$type_tag;
      ...
      src="http://www.googleadservices.com/pagead/conversion/1071686481/?value=0&amp;label=DUh-CI3g8gMQ0caC_wM&amp;guid=ON&amp;script=0"/>
			...
			<!-- trade tracker-->
			<?php
			if($_GET['type']!='callback' && ($customers_value['activation_discount_code_id'] == 1097 || $customers_value['activation_discount_code_id'] == 1098))
			{
			...
			$url = 'http://www.dvdpost.be/belgie/conversion.php?campaignID=2946&productID='.$tracker_id.'&conversionType=lead&https=0&transactionID='. $customer_id.'&email='.$email_address.'&descrMerchant='.$_GET['type'].'&descrAffiliate='.$_GET['type'];
