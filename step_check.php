...
if (!tep_session_is_registered('customer_id')) {
	...
	if( $customers_registration_step<33){
		...
		}else
		{
            ...
            $nvpstr=
"&PAYMENTREQUEST_0_PAYMENTACTION=AUTHORIZATION&PAYMENTREQUEST_0_AMT=0&PAYMENTREQUEST_0_CURRENCYCODE=EUR&L_BILLINGTYPE0=MerchantInitiatedBilling&L_BILLINGAGREEMENTDESCRIPTION0=".urlencode("DVDPost")."&cancelUrl=".urlencode('http://www.dvdpost.be/step_check.php')."&returnUrl=".urlencode('http:///www.dvdpost.be/paypal_process.php');
