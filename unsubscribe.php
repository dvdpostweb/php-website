...
tep_db_query("update contest set unsubscribe= 1,marketing_ok ='NO' where  email = '" . $HTTP_GET_VARS['customers_email'] . "' ");

tep_db_query("update quizz  set unsubscribe= 1, marketing_ok ='NO' where  email = '" . $HTTP_GET_VARS['customers_email'] . "' ");
tep_db_query("update prospects  set unsubscribe= 1 where  customers_email_address = '" . $HTTP_GET_VARS['customers_email'] . "' ");
