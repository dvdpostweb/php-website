...
$current_page_name = 'step_subscription_confirm.php';
...
if ($HTTP_POST_VARS['products_id'] <> 2){
	  ...
	  if ($HTTP_POST_VARS['discount_code'] =='BCC06' or $HTTP_POST_VARS['discount_code'] =='bcc06') {
	    tep_redirect(tep_href_link('step_subscription_info.php?products_id=2', '', 'SSL'));	  
	  }	  
	  if ($HTTP_POST_VARS['discount_code'] =='3TBASIC' or $HTTP_POST_VARS['discount_code'] =='3tbasic') {
	    tep_redirect(tep_href_link('step_subscription_info.php?products_id=2&discount_code=3TBASIC', '', 'SSL'));	  
	  }	 
...
if (strlen($HTTP_POST_VARS['payment']) < 1) {
	tep_redirect(tep_href_link('step_subscription_info.php?error=1&products_id='. $HTTP_POST_VARS['products_id'] .'&discount_code_id=' . $HTTP_POST_VARS['discount_code_id'] , '', 'SSL'));	  
 }
