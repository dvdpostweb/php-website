...
if (!isAdult($HTTP_POST_VARS['products_id'])){
		...
		$sql_addtowishlist  = " insert into " . TABLE_WISHLIST . " select null, c.customers_id, '" . $HTTP_POST_VARS['products_id'] . "', ifnull(w1.rank,0)+1,2, now(), 'DVD_NORM', 1 ,'".$assigned."'"; //BEN001
